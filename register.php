...
<body>
  <main>
    <div class="container-fluid container">
      <form method="POST" action="model/signModel.php" >
        <h2>Crear cuenta</h2>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="cont"> Usuario o contraseña incorrecta, si no has creado una cuenta, <a href="register.php" id="sig">Registrate</a> </p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="bonotaso">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
...
if (urlParams.get('error') === '1') {
    ...
    messa.innerText="para ingresar, inicia sesion";
    loginErrorModal.show();
}</script>  
</body>